    ...
    <form className="mb-10" onSubmit={ onSubmit }>
        ...
        <div className="flex mt-2 w-full justify-between">
          <div className="flex w-full gap-3 items-center box-border">
            <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md w-full">
              <input 
                type="text"  
                name="Description" 
                id="username" 
                onChange={ evt => setDescription( evt.target.value) }
                className="block flex-1 border-0 bg-transparent outline-none py-1.5 px-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm/6" placeholder="Description" />
            </div>
